        ...
        <div className="row">
          ...
          <div className="col-md-6 mb-4">
            <div className="bg-white p-4 rounded shadow">
              ...
              <div className="mb-3">
                <label htmlFor="nombreFabricante" className="form-label">
                  Nombre o razón social
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmlFor="dniFabricante" className="form-label">
                  DNI/CUIT
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="domicilioFabricante" className="form-label">
                  Domicilio
                </label>
                <input
                  type="text"
                  className="form-control"
                  id="domicilioFabricante"
                  placeholder="Ingrese el domicilio"
                />
              </div>
              <div className="mb-3">
                <label htmlFor="localidadFabricante" className="form-label">
                  Localidad
                </label>
                <input
                  type="text"
                  className="form-control"
                  id="localidadFabricante"
                  placeholder="Ingrese la localidad"
                />
              </div>
              <div className="mb-3">
                <label htmlFor="postalFabricante" className="form-label">
                  Código postal
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="telefonoFabricante" className="form-label">
                  Teléfono
                </label>
                <input
                  type="number"
                  className="form-control"
                  id="telefonoFabricante"
                  placeholder="Ingrese el teléfono"
                />
              </div>
              <div className="mb-3">
                <label htmlFor="emailFabricante" className="form-label">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="mb-3">
                <label htmlFor="faxFabricante" className="form-label">
                  Fax
                </label>
                <input
                  type="number"
        ...
        <div className="row">
          ...
          <div className="col-md-7 mb-4">
            <div className="bg-white p-4 rounded shadow">
              ...
              <div className="mb-3">
                <label htmlFor="nombreTecnico" className="form-label">
                  Nombre o razón social
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmlFor="dniTecnico" className="form-label">
                  DNI/CUIT
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="domicilioTecnico" className="form-label">
                  Domicilio
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmlFor="localidadTecnico" className="form-label">
                  Localidad
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmlFor="postalTecnico" className="form-label">
                  Código postal
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="telefonoTecnico" className="form-label">
                  Teléfono
                </label>
                <input
                  type="number"
              ...
              <div className="mb-3">
                <label htmlFor="emailTecnico" className="form-label">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="mb-3">
                <label htmlFor="faxTecnico" className="form-label">
                  Fax
                </label>
                <input
                  type="number"
